class Blog < ActiveRecord::Base
  attr_accessible :title, :body, :author, :views,:published,:attachments_attributes, :images_attributes
  belongs_to :user , :foreign_key => :author
  has_many :attachments, :as => :attachable , :dependent => :destroy
  has_many :images , :as => :imageattachable, :dependent => :destroy
  ...
  accepts_nested_attributes_for :images , :reject_if => lambda { |a| a[:file].blank? }, :allow_destroy => true
