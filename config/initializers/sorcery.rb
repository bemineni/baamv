...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :user_activation, :brute_force_protection, :session_timeout]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = Accountverification
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = Accountverification
    ...
    # Default: `nil`
    #
    user.unlock_token_mailer = Accountverification
